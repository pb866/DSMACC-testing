...
NOXARRAY(:)= (/'NO2   ','NO    ','NO3   ','HONO  ','HNO2  ',&
    ...
    if (CONSTRAIN_NOX) then 
        ...
        !   Parameters :  index_loc = daycounter                                O
        !
        ! ****************************************************************
        ...
        !CO                  The significant part of STRING can be accessed withO
        !CO                  the declaration STRING(1:LENGTH).
        !CO
        !CO         IERR - INTEGER variable giving return condition:
        !CO                IERR = 0 for normal return;
        !CO                IERR = 1 if NUM cannot be converted to STRING becauseO
        ...
        !CO                       wrong with an integer-to-character conversion.O
        !CO
        !C       ALGORITHM:
        !CA
